...
html = requests.get(url, headers = he   aders).text
...
url2 = "https://www.ted.com/talks/11087/transcript.json?language=en"
params = {'language': 'en'
}
headers = {
        'Accept' : 'application/json'
        'Referer': 'https://www.ted.com/talks/minda_dentler_what_i_learned_when_i_conquered_the_world_s_toughest_triathlon/transcript'
